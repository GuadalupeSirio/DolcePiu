<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VPedidos.aspx.cs" Inherits="GestorPedidos_DocePiu.VPedidos" %>
    ...
    <div class="wrapper">
         <form class="formulario" id="form1" runat="server">
            <div class="navegador">
                ...
                <div>
                    <div class="visual-prueba">
                        <div class="perfil">
                            <asp:Label ID="lblPedidos" class="titulo" runat="server" Text="Pedidos realizados"></asp:Label>
                       
                            <div class="grids-form">
                               <div  style="overflow: auto; height: 400px;">
                                 <asp:GridView ID="gvMostrarPedidos" runat="server" AutoGenerateColumns="False" Visible="false">
                                    <Columns>
                                        <asp:BoundField DataField="id" HeaderText="N° Pedido" ItemStyle-CssClass="grid-spacing" HeaderStyle-CssClass="grid-spacing"/>
                                        ...
                                        <asp:TemplateField HeaderText="Factura Pedido" ItemStyle-CssClass="grid-spacing" HeaderStyle-CssClass="grid-spacing">
                                            <ItemTemplate>
