<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VPerfil.aspx.cs" Inherits="GestorPedidos_DocePiu.VPerfil" %>
...
<body>
    ...
    <div class="wrapper">
       <form class="perfil-f formulario" id="form1" runat="server">
            <div class="navegador">
                ...
                <div class="prueba">
                   <div class="img-perfil">
                    ...
                    <div class="perfil">
                            ...
                            <div class="lbtn">
                                <asp:Button ID="btnCerrarSesion" runat="server" CssClass="btn btn-danger" Text="Cerrar Sesión" OnClick="btnCerrarSesion_Click" />
                            </div>
                        </div>
                   </div>
             </div>
